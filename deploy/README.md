...
157 exact `301` rules and 13 exact `410` rules. Its targets are already absolute
...
The expected production manifest contains 40 canonical routes, 46 HTML files
(including four redirect-only documents), 72 download records, 157 redirects

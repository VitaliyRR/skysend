...
composition=f'''<svg xmlns="http://www.w3.org/2000/svg" width="1120" height="510" viewBox="0 0 1120 510" role="img" aria-labelledby="title desc"><title id="title">Варианты интерфейса из материалов SkySend</title><desc id="desc">Два реальных экрана из верхнего ряда оригинального 8_full.png. Слева меню провайдеров, справа меню услуг. Изображения показаны через ограниченные области просмотра SVG без изменения исходных пикселей. Нижний ряд с промо полностью скрыт. Это архивные экраны ПО, не макет нового интерфейса.</desc><rect width="1120" height="510" fill="#FFFFFF"/><text x="32" y="46" font-family="Inter,Arial,sans-serif" font-size="27" font-weight="600" fill="#111315">Варианты интерфейса из материалов SkySend</text><defs><image id="source-screen" width="1188" height="904" href="data:image/png;base64,{encoded}"/></defs><svg x="32" y="80" width="516" height="384" viewBox="16 15 566 420" overflow="hidden" preserveAspectRatio="xMidYMid meet"><use href="#source-screen"/></svg><svg x="572" y="80" width="516" height="384" viewBox="609 10 566 426" overflow="hidden" preserveAspectRatio="xMidYMid meet"><use href="#source-screen"/></svg><text x="32" y="491" font-family="Inter,Arial,sans-serif" font-size="15" fill="#5F6368">Исходные экраны ПО: варианты фона, цвета и состава элементов.</text></svg>'''

...
for p in files:
 ...
 if p.stem=='interface-customization':
  source='https://skysend.ru/images/downloads/po/8_full.png';notes='Компоновка реальных двух экранов из верхнего ряда: SVG viewport clipping без изменения пикселей. Полный source PNG встроен один раз; нижние промо вне viewports. Координаты (16,15,566,420) и (609,10,566,426). Визуально проверено. Для сайта возможен статический AVIF/WebP экспорт видимой композиции.';kind='generated-layout'
